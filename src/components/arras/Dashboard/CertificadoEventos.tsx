    ...
    <Card className="bg-muted/10 border-l-4 border-l-accent">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          ...
          <img src={eidasIcon} alt="eIDAS" className="h-8 w-auto" />
        </div>
        <p className="text-xs text-muted-foreground">Auditoría en Tiempo Real</p>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          {events.length === 0 ? (
            ...
            <div className="relative border-l border-muted ml-2 pl-4 space-y-4">
