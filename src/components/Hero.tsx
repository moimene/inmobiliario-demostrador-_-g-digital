          ...
          <div className="space-y-6">
            ...
            <div className="inline-flex flex-col gap-1 px-4 py-3 bg-primary/10 border-2 border-primary/30 rounded-xl shadow-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-accent">Facilitea</span>
              </div>
            </div>
            ...
            <h1 className="space-y-3 leading-tight">
              ...
              <div className="text-xl md:text-2xl text-accent font-medium">
                Reforzando, transparencia, confianza y la seguridad jurídica del ecosistema Facilitea.
              </div>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Button size="lg" onClick={scrollToDemos} className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg shadow-xl hover:shadow-2xl hover:scale-105 hover:-translate-y-1 ring-2 ring-offset-2 ring-primary/20 hover:ring-primary/40 transition-all duration-200 cursor-pointer">
