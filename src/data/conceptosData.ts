...
export const conceptos: Concepto[] = [
  ...
  },
  {
    ...
    descripcionCompleta: "Existen tres niveles de firma electrónica según eIDAS: simple, avanzada y cualificada. La firma simple (ej: tick en una casilla) tiene validez legal pero baja fuerza probatoria. La firma avanzada requiere identificación del firmante, control exclusivo del medio de firma y detección de alteraciones posteriores (ej: OTP + sello de tiempo). La firma cualificada requiere además un certificado cualificado emitido por un QTSP y dispositivo seguro de creación. InmoServTech utiliza firmas electrónicas avanzadas respaldadas por sellos de tiempo cualificado: el usuario se identifica mediante OTP (autenticación), acepta en el canal certificado (firma), y EAD Trust aplica un sello de tiempo cualificado que proporciona la fuerza probatoria legal. Este modelo ofrece el equilibrio óptimo entre usabilidad y seguridad jurídica.",
    icono: "PenTool",
  },
  {
    id: "qtsp",
    ...
    descripcionCompleta: "Un Qualified Trust Services Provider (QTSP) o Prestador Cualificado de Servicios de Confianza es una entidad autorizada para emitir certificados cualificados, sellos de tiempo, servicios de entrega certificada y custodia electrónica bajo el Reglamento eIDAS. Estas entidades están sujetas a auditorías técnicas y de seguridad periódicas por organismos de supervisión nacionales (en España, el Ministerio de Asuntos Económicos y Transformación Digital). EAD Trust actúa como QTSP en InmoServTech: es quien certifica todas las comunicaciones, aplica los sellos de tiempo, gestiona la custodia electrónica de expedientes y emite los certificados de verificación. InmoServTech es la plataforma que orquesta los procesos; EAD Trust es el proveedor regulado que garantiza la validez legal.",
    icono: "BadgeCheck",
    destacado: true
  },
